...
export default function Nav() {
  ...
  return (
    <div className="sticky top-0 z-50">
      <a
        href="https://www.team-spectra.com"
        target="_blank"
        rel="noopener noreferrer"
        className="block bg-orange-500 hover:bg-orange-600 text-white text-center text-sm font-semibold py-2 px-4 transition-colors"
      >
        Follow Max and Ilan&apos;s adventures with Team Spectra &rarr;
      </a>
      <nav className="bg-[#0a0a0a]/90 backdrop-blur border-b border-[#2a2a2a]">
